...
from src.view import resources_autoclicker
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(363, 258))
        MainWindow.setMaximumSize(QtCore.QSize(363, 259))
        MainWindow.setAcceptDrops(False)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Icons/Autoclicker_Icon.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        MainWindow.setWindowIcon(icon)
        MainWindow.setStyleSheet("QMenuBar { color: black;}\n"
        ...
        self.frame.setGeometry(QtCore.QRect(-1, 0, 371, 241))
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(20, 10, 331, 211))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 0, 321, 221))
        self.groupBox_2.setAutoFillBackground(False)
        self.groupBox_2.setStyleSheet("QGroupBox { border: 0; }")
        self.groupBox_2.setTitle("")
        self.groupBox_2.setObjectName("groupBox_2")
        self.label_4 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_4.setGeometry(QtCore.QRect(0, 40, 71, 21))
        font = QtGui.QFont()
        ...
        self.label_5.setGeometry(QtCore.QRect(0, 170, 311, 41))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        ...
        self.label_6.setGeometry(QtCore.QRect(0, 60, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_7.setGeometry(QtCore.QRect(0, 150, 101, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.labelRATA = QtWidgets.QLabel(parent=self.groupBox_2)
        self.labelRATA.setGeometry(QtCore.QRect(140, 0, 181, 171))
        self.labelRATA.setText("")
        self.labelRATA.setPixmap(QtGui.QPixmap(":/Images/ratatuil.png"))
        self.labelRATA.setScaledContents(True)
        self.labelRATA.setObjectName("labelRATA")
        ...
        self.label_2.setStyleSheet("color: #efeaff;\n"
                                   "font-weight: 525;")
        self.label_2.setObjectName("label_2")
        self.doubleSpinBoxInterval = QtWidgets.QDoubleSpinBox(parent=self.groupBox)
        self.doubleSpinBoxInterval.setGeometry(QtCore.QRect(240, 10, 62, 22))
        self.doubleSpinBoxInterval.setStyleSheet("font: 10pt \"Segoe UI\";\n"
        ...
        self.label_3.setGeometry(QtCore.QRect(310, 10, 31, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.label_3.setFont(font)
        self.label_3.setStyleSheet("color: #efeaff;\n"
                                   "font-weight: 525;")
        ...
        self.label.setStyleSheet("color: #efeaff;\n"
                                 "font-weight: 525;")
        self.label.setObjectName("label")
        self.comboBoxKey = QtWidgets.QComboBox(parent=self.groupBox)
        self.comboBoxKey.setGeometry(QtCore.QRect(130, 60, 111, 22))
        self.comboBoxKey.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.comboBoxKey.setStyleSheet("font: 10pt \"Segoe UI\";\n"
                                       "background-color: #f9f5fe;")
        ...
        self.pushButtonDetectarTecla.setGeometry(QtCore.QRect(260, 50, 61, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        font.setBold(True)
        font.setItalic(False)
        self.pushButtonDetectarTecla.setFont(font)
        self.pushButtonDetectarTecla.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.pushButtonDetectarTecla.setStyleSheet("background-color: #813cbd;\n"
                                                   "color: white;\n"
                                                   "border-radius: 10px;\n"
        ...
        self.label_8.setStyleSheet("color: #efeaff;\n"
                                   "font-weight: 525;")
        self.label_8.setObjectName("label_8")
        self.comboBoxRepeatKey = QtWidgets.QComboBox(parent=self.groupBox)
        self.comboBoxRepeatKey.setGeometry(QtCore.QRect(110, 116, 111, 25))
        self.comboBoxRepeatKey.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.comboBoxRepeatKey.setStyleSheet("font: 10pt \"Segoe UI\";\n"
                                             "background-color: #f9f5fe;")
        ...
        font = QtGui.QFont()
        font.setBold(True)
        self.pushButtonEmpezar.setFont(font)
        self.pushButtonEmpezar.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.pushButtonEmpezar.setStyleSheet("color: white;\n"
                                             "background-color: #813cbd;\n"
                                             "border-radius: 5px;")
        ...
        self.pushButtonPausar.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Cualquier uso fuera de las políticas y/o reglas \n"
                                                      "de otros programas, queda bajo la responsabilidad del usuario."))
        self.label_6.setText(_translate("MainWindow", " josueelpapi123"))
        self.label_7.setText(_translate("MainWindow", "Advertencia"))
        self.label_2.setText(_translate("MainWindow", "Intervalo de repetición (sugerido 0.03):"))
        ...
        self.comboBoxRepeatKey.setItemText(0, _translate("MainWindow", "Button.left"))
        self.comboBoxRepeatKey.setItemText(1, _translate("MainWindow", "Button.right"))
